...
/**
 * Servlet implementation class GetRecordByPassAndEmail
 */
@WebServlet("/GetRecordByPassAndEmail")
public class GetRecordByPassAndEmail extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetRecordByPassAndEmail() {
        super();
