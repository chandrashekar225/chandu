...
<body>
 <form action="./RegistrationServlet" method="post">
  ...
  <div class="input-container">
    ...
    <input class="input-field" type="text" placeholder="Username" name="user" id="user" required />
  </div>

  <div class="input-container">
    <i class="fa fa-envelope icon"></i>
    <input class="input-field" type="text" placeholder="Email" name="email" id="email" required /><span id="iderror" style="color:red;"></span>
  </div>
